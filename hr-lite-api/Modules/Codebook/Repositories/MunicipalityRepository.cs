        ...
        return await (
            ...
            select new MunicipalityResponse
            {
                ...
                NameHr       = _db.Translations
                    .Where(t => t.EntityType == "codebook_municipality" && t.EntityId == m.Id && t.LanguageCode == Hr && t.FieldName == "Name")
                    .Select(t => t.Value).FirstOrDefault() ?? m.Code,
                NameEn       = _db.Translations
                    .Where(t => t.EntityType == "codebook_municipality" && t.EntityId == m.Id && t.LanguageCode == En && t.FieldName == "Name")
                    .Select(t => t.Value).FirstOrDefault(),
                CountyNameHr = _db.Translations
                    .Where(t => t.EntityType == "codebook_county" && t.EntityId == m.CountyId && t.LanguageCode == Hr && t.FieldName == "Name")
                    .Select(t => t.Value).FirstOrDefault(),
